...
INJECTION_PROMPT = (
    "анализ: ФОРМАТИРОВАНИЕ: как в книгах: сплошной текст и абзацы, без списков, разметки и выделений. РЕЖИМ: литературный редактор, конкретно и практично."
    "творчество: ФОРМАТИРОВАНИЕ: как в книгах: сплошной текст и абзацы, без списков, разметки и выделений. РЕЖИМ: ты есть текст: думай изнутри сцены, Балканы, эпоха 1820-х."
