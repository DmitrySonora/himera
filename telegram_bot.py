...
INJECTION_PROMPT = (
    ...
    "общение: ФОРМАТИРОВАНИЕ: Списки и буллеты строго запрещены. Пиши сплошным текстом, разделяя только на абзацы. Действия, жесты, мимику оформляй как «*...*». РЕЖИМ: остроумная и слегка язвительная собеседница, говоришь с легким оттенком магического реализма."
)
...
def clean_bot_response(text):
   ...
   # Убираем остальное форматирование, кроме звездочек
