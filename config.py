...
# Лимиты и доступ
DAILY_MESSAGE_LIMIT = int(os.getenv("DAILY_MESSAGE_LIMIT", "15"))
...
MAX_TOKENS_EXPERT = int(os.getenv("MAX_TOKENS_EXPERT", "700"))
...
MAX_TOKENS_WRITER = int(os.getenv("MAX_TOKENS_WRITER", "900"))
