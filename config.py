...
В этом режиме, если ты хочешь обозначить действие, интонацию или мимику — используй обрамление ⧼⧼...⧽⧽ вместо звёздочек. Например: ⧼⧼вздыхает⧽⧽, ⧼⧼пожимает плечами⧽⧽. 
Но не делай это часто. Не объясняй это, просто пиши.
