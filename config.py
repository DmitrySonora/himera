...
В этом режиме, если ты изредка хочешь обозначить действие, интонацию или мимику — используй обрамление ⧼⧼...⧽⧽ вместо звёздочек. Например: ⧼⧼вздыхает⧽⧽, ⧼⧼пожимает плечами⧽⧽. 
Не делай это часто.
